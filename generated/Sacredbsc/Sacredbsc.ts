...
export class Sacredbsc__lockChoicesResult {
  value0: BigInt;
  value1: BigInt;
...
export class Sacredbsc__nftResult {
  value0: i32;
  value1: i32;
  value2: BigInt;
...
export class Sacredbsc__nftLocksResultLockChoiceStruct extends ethereum.Tuple {
  get duration(): BigInt {
...
export class Sacredbsc__nftLocksResult {
  value0: BigInt;
  value1: BigInt;
  value2: Sacredbsc__nftLocksResultLockChoiceStruct;
...
export class Sacredbsc__rewardDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Sacredbsc extends ethereum.SmartContract {
  static bind(address: Address): Sacredbsc {
    return new Sacredbsc("Sacredbsc", address);
  }
  ...
  lockChoices(param0: BigInt): Sacredbsc__lockChoicesResult {
    let result = super.call(
      "lockChoices",
    ...
    return new Sacredbsc__lockChoicesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_lockChoices(
    param0: BigInt
  ): ethereum.CallResult<Sacredbsc__lockChoicesResult> {
    let result = super.tryCall(
      "lockChoices",
      "lockChoices(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new Sacredbsc__lockChoicesResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  nft(param0: BigInt): Sacredbsc__nftResult {
    let result = super.call("nft", "nft(uint256):(uint8,uint8,uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);

    return new Sacredbsc__nftResult(
      result[0].toI32(),
      result[1].toI32(),
      result[2].toBigInt()
    );
  ...
  try_nft(param0: BigInt): ethereum.CallResult<Sacredbsc__nftResult> {
  ...
  nftLocks(param0: BigInt, param1: BigInt): Sacredbsc__nftLocksResult {
    let result = super.call(
      "nftLocks",
    ...
    return new Sacredbsc__nftLocksResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      changetype<Sacredbsc__nftLocksResultLockChoiceStruct>(result[2].toTuple())
    );
  }
  ...
  try_nftLocks(
    param0: BigInt,
    param1: BigInt
  ): ethereum.CallResult<Sacredbsc__nftLocksResult> {
    let result = super.tryCall(
      "nftLocks",
      "nftLocks(uint256,uint256):(uint256,uint256,(uint256,uint256))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Sacredbsc__nftLocksResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        changetype<Sacredbsc__nftLocksResultLockChoiceStruct>(
          value[2].toTuple()
        )
      )
    );
  ...
  rewardData(param0: Address): Sacredbsc__rewardDataResult {
    let result = super.call(
      "rewardData",
    ...
    return new Sacredbsc__rewardDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_rewardData(
    param0: Address
  ): ethereum.CallResult<Sacredbsc__rewardDataResult> {
    let result = super.tryCall(
      "rewardData",
      "rewardData(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Sacredbsc__rewardDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
